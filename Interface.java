...
static class game{
	...
	public  Interface() {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e)  {
				if((rdbtnNewRadioButton.isSelected()&& game.move%2==0)||(rdbtnNewRadioButton_1.isSelected()&& game.move%2==1)) {
			    try { 
				...
				game.score=	game.score + Code.CheckPairPoints(game.state[playerMove], game.state[playerMove-1]);
